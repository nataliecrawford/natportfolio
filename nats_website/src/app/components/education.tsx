...
const Education = () => {
  ...
  return (
    <div>
      ...
      <div
        className="relative w-[90%] aspect-[19/10] rounded-xl bg-contain bg-center left-1/22"
      ...
      >
        ...
        <div
          ...
          className="absolute top-[26%] left-[24%] w-[30px] h-[130px] cursor-pointer"
        >
          {hovered === "card1" && (
            <div className="absolute top-[-145%] left-[-440%] w-75 p-4 bg-white border rounded-lg shadow-lg z-10">
        ...
        <div
          ...
          onMouseLeave={() => setHovered(null)}
          className="absolute top-[15%] left-[45.5%] w-[35px] h-[130px] cursor-pointer"
        >
          {hovered === "card2" && (
            <div className="absolute top-[-95%] left-[-375%] w-75 p-4 bg-white border rounded-lg shadow-lg z-10">
